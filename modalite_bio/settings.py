...
SECRET_KEY = 'django-insecure-v_+3+^y0njh2vcm#ig!1n1sdl)7i=sh&@i$yvm$#+-o8eegmp!'
...
ROOT_URLCONF = 'modalite_bio.urls'
...
WSGI_APPLICATION = 'modalite_bio.wsgi.application'
